...
flags.DEFINE_float('threshold', 200, 'Threshold for step 1 (selection).')
flags.DEFINE_float('sigma1', 150, 'Sigma for step 1 (selection).')
flags.DEFINE_float('sigma2', 40, 'Sigma for step 2 (argmax).')
flags.DEFINE_integer('queries', 200, 'Number of queries made by the student.')
